 ...
 *
 * @package hundope
 *The code refered to as link rel="shortcut icon" below the head represents a custom favicon on the page tab left to our website name, visualized as a hand that we created.
**/
?><!DOCTYPE html>
